import database_with_csv


def prompt_add_book():
    name = input("Enter the name of the book:")
    author = input("Enter the name of the author:")
    database_with_csv.add_book(name,author)


def list_books():
    books = database_with_csv.get_all_books()
    for book in books:
...
def prompt_read_book():
    ...
    database_with_csv.mark_book_as_read(name)


def prompt_delete_book():
    name = input("Enter the book name you want to delete:")
    database_with_csv.delete_book(name)
